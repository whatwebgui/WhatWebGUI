...
public class FormatterController {
    ...
    private void executeCommand(Extension ext, String domain) throws IOException {
        ...
        switch (type) {
            case "shell":
                command = "/home/duxon/Apps/WhatWeb-0.5.4/whatweb --color=never --log-brief=" + path2 + domain + extension + " " + target+"/";
                break;
            case "ruby":
            ...
            case "mongo":
                ...
                break;
            default:
                command = "/home/duxon/Apps/WhatWeb-0.5.4/whatweb --color=never --log-" + type + "=" + path2 + domain + extension + " " + target+"/";
                break;
        }
        if (System.getProperty("os.name").toLowerCase().contains("win")) {
